...
import { CHAIN_NAMESPACES, OPENLOGIN_NETWORK, WALLET_ADAPTERS, WEB3AUTH_NETWORK } from "@web3auth/base";
...
function getWebviewContent() {
  ...
  const scriptUri = "https://cdn.jsdelivr.net/npm/@web3auth/web3auth@1.2.4/dist/web3auth.umd.min.js"
